...
process.load("SandBox.Stop.dPhiFilter_cfi")
process.load("SandBox.Stop.signifFilter_cfi")
process.load("SandBox.Stop.newHTFilter_cfi")
process.load("SandBox.Stop.matchTrigJetsFilter_cfi")
